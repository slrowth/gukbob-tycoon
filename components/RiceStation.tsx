...
const RiceStation: React.FC<RiceStationProps> = ({ pots, onInteract }) => {
  return (
    <div className="flex flex-col gap-0 bg-gray-800 p-1 rounded-lg border-4 border-gray-600 h-full shadow-[inset_0_0_10px_rgba(0,0,0,0.5)] overflow-hidden">
      {/* Header Label */}
      <div className="text-center text-[10px] text-white bg-gray-700/80 rounded py-0.5 mb-0.5 font-bold shadow-sm border border-gray-500 leading-tight shrink-0">
        솥밥
      </div>
