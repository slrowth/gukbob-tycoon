...
const Stove: React.FC<StoveProps> = ({ pots, onInteract }) => {
  ...
  return (
    <div className="flex flex-col w-full bg-gray-800 p-2 rounded-lg border-4 border-gray-600 relative shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]">
      ...
      {/* Grid Container - Adjusted to fit content */}
      <div className="grid grid-cols-3 gap-1 relative content-start">
        ...
        {pots.map((pot) => {
          ...
          return (
            <button
              ...
              `}
              // Removed minHeight to let it scale naturally
            >
